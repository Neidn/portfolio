...
const PublicationCard = ({ pub, theme }) => {
  ...
  return (
    <div
      className={styles["publication-card-div"]}
      style={{ backgroundColor: theme.highlight }}
    >
      <Fade bottom duration={2000} distance="40px">
        <div key={pub.id} onClick={() => openPubinNewTab(pub.url)}>
          <div className={styles["publication-name-div"]}>
            <p
              className={styles["publication-name"]}
          ...
          <p
            className={styles["publication-description"]}
            style={{ color: theme.text }}
          >
            {pub.description}
          </p>
          <div className={styles["publication-details"]}>
            <p
              className={styles["publication-creation-date subTitle"]}
